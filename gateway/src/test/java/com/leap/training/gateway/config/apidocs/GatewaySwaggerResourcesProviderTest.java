package com.leap.training.gateway.config.apidocs;

import static com.leap.training.gateway.config.apidocs.GatewaySwaggerResourcesProvider.swaggerResource;
